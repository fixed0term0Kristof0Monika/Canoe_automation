...
class HTMLReporter(object):
    ...
    def renew_template_text(self, logo_url):
        ...
        template_text = template_text.replace("__test_archive_row__", str(_test_metrics_content))
        ...
        for i, val in enumerate(f):
            with open(val) as json_file:
                ...
                <style>
                   ...
                   <div class = "row d-flex align-content-center flex-wrap " style= "padding-right:230px; margin:10px auto 30px; height:100%;">
                        <div id="list-item-__acount__" class="card col-sm-5 " style= " height:97%;" >
                            ...
                            <div style="margin-top: -5%; display:flex; flex-direction: column;">
                                <div id="archive-container-__iloop__" style="padding-top: 5%; text-align: center;">
                                    <div style=" margin :0; margin-top:30%;">
                                ...
                                <div class="archive-chart-container">
                                    <canvas id="archive-chart-__iloop__" style="margin-top: 10%; "></canvas>
                                </div>
                            </div>
                                ...
                                <section id="statistic" class="statistic-section-__status__ one-page-section">
                                    <div class="container" style="margin-top: -2%;">
                                        <div class="row text-center">
                                            <div class="col-xs-12 col-md-3" style="max-width: 25%;">
                                                <div class="counter">
                                            ...
                                            <div class="col-xs-12 col-md-3" style="max-width: 25%;"v>
                                                <div class="counter">
                         ...
                         <div class="col card" style="margin-left: 0.75%; height: 97%;" width:55%;>
                            ...
                            <div class= "table-responsive">
                                    <table class="table row-border tablecard" id="tm" style="width:100%; margin:2% auto;">
                ...
                _archive_body_text = _archive_body_text.replace("__test_archive_row__", data['status_list']['error'])
                _archive_body_text = _archive_body_text.replace("__test_archive_row__", str(_test_metrics_content))
